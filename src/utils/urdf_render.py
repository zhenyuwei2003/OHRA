...
def urdf_render(hand_params, output_path, is_extended=False):
    dir_path = f"{ROOT_DIR}/assets/canonical_extended" if is_extended else f"{ROOT_DIR}/assets/canonical"
    env = Environment(
...
if __name__ == "__main__":
    ...
    urdf_render(hand_params, output_path, args.extended)
