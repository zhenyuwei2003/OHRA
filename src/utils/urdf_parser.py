...
def parser_base(robot_name):
    meta_info = json.load(open(os.path.join(ROOT_DIR, f"assets/meta_infos/base/{robot_name}.json")))
...
if __name__ == "__main__":
    ...
    if args.extended:
        ...
        json_save_infos = parser_base(args.robot_name)

    output_path = os.path.join(ROOT_DIR, f"assets/canonical{'_extended' if args.extended else ''}/json/{args.robot_name}.json")
